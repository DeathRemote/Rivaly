    ...
    >
      {success ? (
        ...
        <div className="relative overflow-hidden text-center">
          ...
          <div className="pointer-events-none absolute -bottom-16 -left-16 h-56 w-56 rounded-full bg-orange-300/10 blur-[80px]" />
          ...
          <div className="relative z-10">
            ...
            <p className="mt-3 text-sm text-white/55 px-4 text-balance">
              ...
              <div className="mb-8">
                <div className="text-left">
                  ...
                  <input
                    ...
                    className={cn(
                      "h-14 w-full rounded-xl bg-black/60 px-6 text-center",
                      "font-display text-2xl font-black italic tracking-[0.45em] text-lime-100",
                      "uppercase placeholder:text-white/20",
                      "border border-transparent focus:outline-none focus:ring-2 focus:ring-lime-300/20",
                      "focus:shadow-[0_0_20px_rgba(202,253,0,0.10)] transition-all",
                    )}
                  />
                </div>

                <p className="mt-4 text-[11px] text-white/35 flex items-center justify-center gap-2">
